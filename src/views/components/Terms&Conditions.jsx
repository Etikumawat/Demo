...
const TermsAndConditions = () => {
  return (
    <div className="terms-container">
      ...
      <p>Welcome to SupplierX!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Aeonx Digital's Website, located at https://supplierx.aeonx.digital.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use SupplierX if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing SupplierX, you agreed to use
        cookies in agreement with the Aeonx Digital's Privacy Policy.{" "}
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, Aeonx Digital and/or its licensors own the
        intellectual property rights for all material on SupplierX. All
        intellectual property rights are reserved. You may access this from
        SupplierX for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from SupplierX</li>
        <li>Sell, rent or sub-license material from SupplierX</li>
        <li>Reproduce, duplicate or copy material from SupplierX</li>
        <li>Redistribute content from SupplierX</li>
      </ul>
      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. Aeonx
        Digital does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Aeonx Digital, its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Aeonx Digital shall not be
      ...
      <p>
        Aeonx Digital reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Aeonx Digital a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Aeonx Digital; and (d) the link
      ...
      <p>
        ...
        e-mail to Aeonx Digital. Please include your name, your organization
      ...
      <p>
        No use of Aeonx Digital's logo or other artwork will be allowed for
