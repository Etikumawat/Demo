  ...
  const request = (reset_offset = true) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        // setTotal(res.data);
        setLoading(false);
        setData(res?.data.data[0]?.fields);
      ...
      <div className="card">
        <div className="card-body pb-1">
          <div className="d-flex justify-content-between align-center">
            <h3 style={{ color: "#E06522" }}>PO View Control</h3>
            <Button
        ...
        <Card>
          <CardHeader style={{ paddingTop: "0rem" }}>
            <CardTitle tag="h4">Edit PO Field</CardTitle>
          </CardHeader>
          <CardBody>
            <Row>
    ...
    <>
      ...
      {showFormViewControl && (
        <div className="card">
          ...
          <Card>
            <CardHeader style={{ paddingTop: "0rem" }}>
              <CardTitle tag="h4">Create PO Field</CardTitle>
            </CardHeader>
            <CardBody>
              <Row>
                <Col className="mb-1" md="4" sm="12">
