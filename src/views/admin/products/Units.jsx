...
//     axios
//       .post(new URL("/api/v1/admin/uom/list", themeConfig.backendUrl), query)
//       .then((res) => {
//         if (res.data.error) {
//           setLoading(false);
...
//           .delete(
//             new URL(
//               `/api/v1/admin/uom/delete/${row.id}`,
...
//       e.preventDefault();
//       axios
//         .post(new URL("/api/v1/admin/uom/create", themeConfig.backendUrl), {
//           ...form,
//         })
//         .then((res) => {
//           if (res.data.error) {
...
//             <h3 style={{ color: "#E06522" }}>Units</h3>
//             <Button
...
//       e.preventDefault();
//       axios
//         .put(new URL("/api/v1/admin/uom/update", themeConfig.backendUrl), form)
//         .then((res) => {
//           if (res.data.error) {
//             toast.error(res.data.message);
//           }
