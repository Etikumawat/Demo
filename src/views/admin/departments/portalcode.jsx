...
const Portalcode = () => {
  ...
  const request = (reset_offset = true) => {
    ...
    axios
      .post(
        new URL("/api/v1/admin/departmentPortalCode/paginate", themeConfig.backendUrl),
        query
      )
      .then((res) => {
        if (res.data.error) {
    ...
    MySwal.fire({
      ...
      if (result.value) {
        axios
          .delete(
            new URL(
              `/api/v1/admin/departmentPortalCode/delete/${row.id}`,
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        setDepartment(response.data.data.rows);
      })
      .catch((error) => {
  ...
  const AddModal = () => {
    ...
    const onSubmit = (e) => {
      ...
      axios
        .post(
          new URL("/api/v1/admin/departmentPortalCode/create", themeConfig.backendUrl),
          { ...form, dept_id: selectedOption.value.toString() }
        )
        .then((res) => {
          if (res.data.error) {
            return toast.error(res.data.message);
            ...
            <ModalBody>
              <div className="row">
                ...
                <div className="col-md-9 me-1 mt-1">
                  <div className="form-group">
                    <label>
                    Portal Code Name<span className="text-danger"> *</span>
                    </label>
                    <input
                      type="text"
                      name="name"
  ...
  const EditModal = () => {
    ...
    const onSubmitEdit = (e) => {
      ...
      axios
        .put(
          new URL("/api/v1/admin/departmentPortalCode/update", themeConfig.backendUrl),
          { ...form, dept_id: selectedOption.value.toString() }
        )
        .then((res) => {
          if (res.data.error) {
            ...
            <ModalBody>
              <div className="row">
                ...
                <div className="col-md-9 me-1 mt-1">
                  <div className="form-group">
                    <label>
                      Postal Code Name<span className="text-danger"> *</span>
                    </label>
                    <input
                      type="text"
                      name="email"
