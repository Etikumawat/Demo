...
const Customizer = (props) => {
  ...
  // const renderbackendUrlRadio = () => {
  //   const [selectedbackendUrl, setSelectedbackendUrl] = useState(
  //     themeConfig.backendUrl
  //   );

  //   const backendUrlArr = [
  //     {
  //       name: "https://dev.api.supplierx.aeonx.digital/api/",
  //       label: "Dev",
  //     },
  //     {
  //       name: "http://10.201.0.198:3000/api/",
  //       label: "Bhavesh",
  //     },
  //     {
  //       name: "http://10.201.0.176:7000/api/",
  //       label: "Hukam",
  //     },
  //     {
  //       name: "http://10.201.1.169:3000/api/",
  //       label: "Rahul",
  //     },
  //   ];

  //   // const handlBackendUrlChange = async (name) => {
  //   //   setSelectedbackendUrl(name);
  //   //   themeConfig.backendUrl = name;

  //   //   // Fetch data from the selected API
  //   //   try {
  //   //     const response = await fetch(name);
  //   //     const data = await response.json();
  //   //     // Process the fetched data here (e.g., update UI, store in state)
  ...
  //   // return backendUrlArr.map((radio, index) => {
  //   //   const marginCondition = index !== backendUrlArr.length - 1;
  ...
  //   //         type="radio"
  //   //         id={radio.name}
  //   //         checked={selectedbackendUrl === radio.name}
  //   //         onChange={() => handlBackendUrlChange(radio.name)}
  //   //       />
      ...
      >
        ...
        <div className="px-2">
          {/* <div className="mb-2">
            ...
            <div className="d-flex">{renderbackendUrlRadio()}</div>
          </div> */}
